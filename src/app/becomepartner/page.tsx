      ...
      <div className="flex flex-col items-center justify-center h-[88vh] gap-20 pt-20">
        ...
        <div className="flex gap-5 sm:gap-10 md:gap-20">
          ...
          <div className="flex flex-col">
            <h1 className="font-bold text-3xl md:text-[42px]">
              Денис Браздецький
            </h1>
            <h2 className="font-light text-2xl md:text-3xl mt-2 mb-5">
              Головний організатор
            </h2>
            <div className="h-0.5 w-full border bg-bec-white border-bec-white mb-5" />
            <div className="flex gap-3 mb-5 text-xl tmd:ext-2xl items-center">
              <Image
                width={40}
                height={40}
                alt="."
              ...
              />
              <Link
                href="mailto:denys.brazdetskyi@best-eu.org"
                className="hover:underline"
              >
                denys.brazdetskyi@best-eu.org
              </Link>
            </div>
            <div className="flex gap-3 text-xl md:text-2xl items-center">
              ...
              />
              <Link href="tel:+380664493594" className="hover:underline">
                +380 66 449 3594
              </Link>
            </div>
          </div>
